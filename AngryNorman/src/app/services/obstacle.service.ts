...
export class Obstacle {
  ...
  /*  game functionalities such as collision and obstacle movements:
  ...
  // collision function for two floating and running obstacles. (https://github.com/deeps8/ng-dino)
